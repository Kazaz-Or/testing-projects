...
from UnitTestFrameWork import app
...
class AppTest(TestCase):
    ...
    def test_menu_calls_print_blogs(self):
        with patch('builtins.input') as mocked_input:
            with patch('UnitTestFrameWork.app.print_blogs') as mocked_print_blogs:
    ...
    def test_menu_calls_ask_read_blogs(self):
        with patch('builtins.input') as mocked_input:
            with patch('UnitTestFrameWork.app.ask_read_blog') as mocked_ask_read_blog:
    ...
    def test_menu_calls_ask_create_post(self):
        with patch('builtins.input') as mocked_input:
            with patch('UnitTestFrameWork.app.ask_create_post') as mocked_ask_create_post:
    ...
    def test_ask_read_blog(self):
        with patch('builtins.input', return_value='Test'):
            with patch('UnitTestFrameWork.app.print_posts') as mocked_print_posts:
                app.ask_read_blog()
    ...
    def test_print_posts(self):
        ...
        with patch('UnitTestFrameWork.app.print_post') as mocked_print_post:
