...
describe('Authorizer test suite', () => {
    ...
    test('should return id for new registered user', async () => {
    ...
    test('should return tokenId for valid credentials', async () => {
    ...
    test('should invalidate token on logout call', async () => {
