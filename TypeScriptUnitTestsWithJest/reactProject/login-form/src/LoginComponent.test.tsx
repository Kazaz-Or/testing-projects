...
describe('Login component tests', ()=>{
    ...
    function setup() {
       container = render(<LoginComponent 
            ...
            setToken={setTokenMock}/>).container;
    ...
    test('Click login button with incomplete credentials - show required message', ()=>{
        const inputs = screen.getAllByTestId('input');
    ...
    test('right credentials - successful login', async ()=>{
    ...
    test('right credentials - successful login - with user calls', async ()=>{
        loginServiceMock.login.mockResolvedValueOnce('1234');
        const inputs = container.querySelectorAll('input');
        const userNameInput = inputs[0];
        const passwordInput = inputs[1];
    ...
    test('right credentials - unsuccessful login', async ()=>{
    ...
    test('right credentials - unsuccessful login - solve act warnings', async ()=>{
